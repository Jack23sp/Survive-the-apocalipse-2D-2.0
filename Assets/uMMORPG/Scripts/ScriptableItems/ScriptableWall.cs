...
[CreateAssetMenu(menuName = "uMMORPG Item/Wall", order = 999)]
public partial class ScriptableWall : UsableItem
{
    ...
    public override void Use(Player player, int inventoryIndex)
    {
        ...
        ModularBuildingManager.singleton.scriptableWall = this;
        ModularBuildingManager.singleton.selectedType = 0;
