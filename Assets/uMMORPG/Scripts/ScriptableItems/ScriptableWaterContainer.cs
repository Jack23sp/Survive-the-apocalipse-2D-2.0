...
[CreateAssetMenu(menuName = "uMMORPG Item/WaterContainer", order = 999)]
public partial class ScriptableWaterContainer : ScriptableBuildingAccessory
{
    ...
    public override void Use(Player player, int inventoryIndex)
    {
        ...
        ModularBuildingManager.singleton.AbleExternalWaterContainerAccessory();
    }
    ...
    static Dictionary<int, ScriptableWaterContainer> cache;
    public static Dictionary<int, ScriptableWaterContainer> dict
    {
        get
        {
            // not loaded yet?
            if (cache == null)
            {
                ...
                ScriptableWaterContainer[] items = Resources.LoadAll<ScriptableWaterContainer>("");
