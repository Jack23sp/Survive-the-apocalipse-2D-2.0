...
public abstract partial class SummonableItem : UsableItem
{
    [Header("Summonable")]
    ...
    public override bool CanUse(Player player, int inventoryIndex)
    {
        ...
        return base.CanUse(player, inventoryIndex) &&
               ...
               summonPrefab != null &&
               //player.inventory.slots[inventoryIndex].item.summonedHealth > 0 &&
               player.inventory.slots[inventoryIndex].item.summonedLevel <= player.level.current;
    }
