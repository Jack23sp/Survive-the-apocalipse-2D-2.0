...
[CreateAssetMenu(menuName = "uMMORPG Item/Dumbbell", order = 999)]
public partial class ScriptableDumbbell : ScriptableBuildingAccessory
{
    [Header("------------Book--------------")]
    public float amountToIncreaseAbility = 0.1f;
    ...
    static Dictionary<int, ScriptableDumbbell> cache;
    public static Dictionary<int, ScriptableDumbbell> dict
    {
        get
        {
            // not loaded yet?
            if (cache == null)
            {
                ...
                ScriptableDumbbell[] items = Resources.LoadAll<ScriptableDumbbell>("");
