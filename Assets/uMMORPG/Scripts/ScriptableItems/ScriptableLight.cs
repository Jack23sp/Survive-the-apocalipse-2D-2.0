...
[CreateAssetMenu(menuName = "uMMORPG Item/Light", order = 999)]
public partial class ScriptableLight : ScriptableBuildingAccessory
{
    ...
    public override void Use(Player player, int inventoryIndex)
    {
        ...
        ModularBuildingManager.singleton.AbleExternalLightAccessory();
    }
    ...
    static Dictionary<int, ScriptableLight> cache;
    public static Dictionary<int, ScriptableLight> dict
    {
        get
        {
            // not loaded yet?
            if (cache == null)
            {
                ...
                ScriptableLight[] items = Resources.LoadAll<ScriptableLight>("");
