...
[CreateAssetMenu(menuName = "uMMORPG Item/Gate", order = 999)]
public partial class ScriptableGate : ScriptableBuildingAccessory
{
    ...
    public override void Use(Player player, int inventoryIndex)
    {
        ...
        {
            GameObject searched = player.playerModularBuilding.FindNearestGate();
        ...
        ModularBuildingManager.singleton.AbleGatePositioning();
        ModularBuildingManager.singleton.scriptableGate = this;
    }
