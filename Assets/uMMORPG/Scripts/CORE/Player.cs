...
public partial class Player : Entity
{
    ...
    public override void OnStartLocalPlayer()
    {
        ...
        playerNavMeshMovement2D.joystick = JoystickManager.singleton.attackJoystick;
        playerNavMeshMovement2D.moveJoystick = JoystickManager.singleton.moveJoystick;

        if (UIMobileControl.singleton)
            UIMobileControl.singleton.Refresh(this);
    ...
    void LateUpdate()
    {
        ...
        {
            animator.SetBool("MOVING", movement.IsMoving() && state != "CASTING");
            //animator.SetBool("SHOOT", playerMove && playerMove.states.Contains("SHOOT"));
