...
public abstract class DamageSkill : ScriptableSkill
{
    ...
    public LinearInt damageToRock = new LinearInt { baseValue = 1 }; // set by skill
    public LinearInt damageToTree = new LinearInt { baseValue = 1 }; // set by skill
    public LinearInt damageToWall = new LinearInt { baseValue = 1 }; // set by skill
    public LinearInt damageToForniture = new LinearInt { baseValue = 1 }; // set by skill
