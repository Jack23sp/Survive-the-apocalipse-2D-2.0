...
[CreateAssetMenu(menuName = "uMMORPG Item/Billboard", order = 999)]
public partial class ScriptableBillboard : ScriptableBuildingAccessory
{
    ...
    public override void Use(Player player, int inventoryIndex)
    {
        ...
        ModularBuildingManager.singleton.AbleExternalBillboardAccessory();
    ...
    static Dictionary<int, ScriptableBillboard> cache;
    public static Dictionary<int, ScriptableBillboard> dict
    {
        get
        {
            // not loaded yet?
            if (cache == null)
            {
                ...
                ScriptableBillboard[] items = Resources.LoadAll<ScriptableBillboard>("");
