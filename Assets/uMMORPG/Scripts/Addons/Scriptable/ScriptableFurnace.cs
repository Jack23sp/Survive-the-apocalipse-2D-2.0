...
[CreateAssetMenu(menuName = "uMMORPG Item/Furnace", order = 999)]
public partial class ScriptableFurnace : ScriptableBuildingAccessory
{
    ...
    public override void Use(Player player, int inventoryIndex)
    {
        ...
        ModularBuildingManager.singleton.AbleExternalFurnaceAccessory();
    }
    ...
    static Dictionary<int, ScriptableFurnace> cache;
    public static Dictionary<int, ScriptableFurnace> dict
    {
        get
        {
            // not loaded yet?
            if (cache == null)
            {
                ...
                ScriptableFurnace[] items = Resources.LoadAll<ScriptableFurnace>("");
